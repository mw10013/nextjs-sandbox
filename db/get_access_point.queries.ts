...
/** Query 'GetAccessPoint' is invalid, so its result is assigned type 'never' */
export type IGetAccessPointResult = never;

/** Query 'GetAccessPoint' is invalid, so its parameters are assigned type 'never' */
export type IGetAccessPointParams = never;

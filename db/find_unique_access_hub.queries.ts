...
/** Query 'FindUniqueAccessHub' is invalid, so its result is assigned type 'never' */
export type IFindUniqueAccessHubResult = never;

/** Query 'FindUniqueAccessHub' is invalid, so its parameters are assigned type 'never' */
export type IFindUniqueAccessHubParams = never;
